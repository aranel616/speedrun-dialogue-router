...
export const script: Script = {
    ...
    "setup_chloe3": {
        "choices": [
            {
                "name": "(Took the blame for Chloe)",
                "text": "",
                "set": {
                    "name": "intervened_for_chloe",
                    "type": "set",
                    "value": true
                },
                "next": "setup_frank3"
    ...
    "campus_6_nathan": {
        "text": "Especially after I just got Nathan expelled...",
        "next": "campus_7"
    },
    "campus_6_david": {
        "text": "Especially after I just got your step-bully suspended...",
        "next": "campus_7"
    },
    "campus_6_jefferson": {
        "text": "Especially after I just got Mr. Jefferson in trouble...",
        "next": "campus_7"
    },
    "campus_6_max": {
        "text": "I mean, I even got my own dumb ass suspended...",
        "next": "campus_7"
    },
    "campus_6_none": {
        "text": "Especially after I see the results... and then it's too late to rewind.",
        "next": "campus_7"
    },
    "campus_7": {
        ...
        "next": [
            {
                ...
                "type": "eq",
                "value": true,
                "node": "campus_8a2_blame"
            },
            {
                "name": "intervened_for_chloe",
                "type": "eq",
                "value": false,
                "node": "campus_8a2_hidden"
            }
        ]
    },
    "campus_8a2_blame": {
        ...
        "next": [
            {
                ...
                "type": "eq",
                "value": true,
                "node": "campus_14_saved"
            },
            {
                "name": "saved_kate",
                "type": "eq",
                "value": false,
                "node": "campus_14_notsaved"
            }
        ]
    },
    "campus_14_saved": {
        ...
        "next": [
            {
                ...
                "type": "eq",
                "value": true,
                "node": "hallway2_2_blame"
            },
            {
                "name": "intervened_for_chloe",
                "type": "eq",
                "value": false,
                "node": "hallway2_2_hidden"
            }
        ]
    },
    "hallway2_2_blame": {
    ...
    "pool_2_susp": {
        "text": "We still have to play it cool, okay? Even if I'm suspended.",
        "next": "pool_3"
    },
    "pool_2_not": {
        "text": "We still have to play it cool, okay? I still go to school here.",
        "next": "pool_3"
    },
    "pool_3": {
        "text": [
        ...
        "choices": [
            {
                ...
                "text": ["Boys, of course!", "Figures. Perv."],
                "next": "pool_5"
            },
            {
                "name": "Girls' locker room.",
                "text": ["Girls, of course!", "Girls? Ooh la-la..."],
                "next": "pool_5"
            }
        ]
    },
    ...
    "pool_6_leave": {
        "text": "You want me to crash where the Blackwell security officer I just busted lives, so I'll be safe? Okay!",
        "next": "pool_7"
    },
    "pool_6_not": {
        "text": "You want me to crash where the Blackwell security officer lives so I'll be safe? Okay!",
        "next": "pool_7"
    },
    "pool_7": {
        "text": [
        ...
        "next": [
            {
                ...
                "type": "eq",
                "value": "max",
                "node": "upstairs_choice_susp"
            },
            {
                "name": "suspended",
                "type": "ne",
                "value": "max",
                "node": "upstairs_choice_not"
            }
        ]
    },
        ...
        "next": [
            {
                ...
                "type": "eq",
                "value": true,
                "node": "downstairs_noway_blame"
            },
            {
                "name": "intervened_for_chloe",
                "type": "eq",
                "value": false,
                "node": "downstairs_noway_hidden"
            }
        ]
    },
        ...
        "next": [
            {
                ...
                "type": "eq",
                "value": "david",
                "node": "downstairs_david_leave"
            },
            {
                "name": "suspended",
                "type": "ne",
                "value": "david",
                "node": "downstairs_david_not"
            }
        ]
    },
        ...
        "next": [
            {
                ...
                "type": "eq",
                "value": "max",
                "node": "downstairs_david2_susp"
            },
            {
                "name": "suspended",
                "type": "ne",
                "value": "max",
                "node": "downstairs_david2_not"
            }
        ]
    },
    "downstairs_david2_susp": {
        "text": "Must be nice to be suspended and have some free time off Blackwell.",
        "next": "downstairs_david3"
    },
    "downstairs_david2_not": {
        "text": "No, you and Chloe think you know more than anybody. Like all teenagers.",
        "next": "downstairs_david3"
    },
    "downstairs_david3": {
        "text": "",
        "next": [
            {
                ...
                "type": "eq",
                "value": "david",
                "node": "downstairs_david3_leave"
            },
            {
                "name": "suspended",
                "type": "ne",
                "value": "david",
                "node": "downstairs_david3_not"
            }
        ]
    },
    "downstairs_david3_leave": {
        "text": "Leave Max alone, David. I can't believe you got fired—no, of course I can believe you got fired. Did you threaten some poor student with the stockade?",
        "next": "downstairs_7"
    },
    "downstairs_david3_not": {
        "text": "Leave Max alone, David. Stop threatening students.",
        "next": "downstairs_7"
    },
    "downstairs_7": {
        "text": [
        ...
        "next": [
            {
                ...
                "type": "eq",
                "value": true,
                "node": "diner_frank1_shot"
            },
            {
                "name": "shot_at_frank",
                "type": "eq",
                "value": false,
                "node": "diner_frank1_not"
            }
        ]
    },
    "diner_frank1_shot": {
        ...
        "next": [
            {
                ...
                "type": "eq",
                "value": true,
                "node": "diner_frank1c_shot"
            },
            {
                "name": "shot_at_frank",
                "type": "eq",
                "value": false,
                "node": "diner_frank1c_not"
            }
        ]
    },
    "diner_frank1c_shot": {
        "text": "Because she looks beautiful in them and you look like ass. Aiming a gun doesn't make you any sexier.",
        "next": "diner_frank1d"
    },
    "diner_frank1c_not": {
        "text": "Because she looks beautiful in them and you look like ass. You're lucky I just took that gun from you...",
        "next": "diner_frank1d"
    },
    "diner_frank1d": {
        "text": [
    ...
    "diner_alyssa": {
        "choices": [
            {
                "name": "(Warn Alyssa)",
                "text": ["Alyssa, watch out!", "Quick thinking, Max!"],
                "next": "rv_1"
            },
            {
                "name": "(Don't warn Alyssa)",
                "text": "I'd love to talk Max, but I'm drowning in puddle scum.",
                "next": "rv_1"
            }
        ]
    },
        ...
        "choices": [
            {
                ...
                "text": "Bullshit, who hasn't?! Fuck everybody!",
                "next": "truck_1_intro"
            },
            {
                "name": "(Sided with David)",
                "text": "Bullshit. You totally defended step-stalker! Fuck everybody!",
                "next": "truck_1_intro"
            }
        ]
    },
