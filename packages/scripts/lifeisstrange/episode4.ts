...
export const script: Script = {
        ...
        "choices": [
            {
                ...
                "text": "",
                "set": {
                    "name": "accepted_warren_invite",
                    "type": "set",
                    "value": true
                },
                "next": "setup4_victoria"
            },
            {
                "name": "(Declined Warren's invitation)",
                "text": "",
                "set": {
                    "name": "accepted_warren_invite",
                    "type": "set",
    ...
    "setup4_suspended": {
        "choices": [
            {
                "name": "(Blamed Nathan → Nathan suspended)",
                "text": "",
                "set": {
                    "name": "suspended",
                    "type": "set",
            ...
            {
                "name": "(Blamed David → David on leave)",
                "text": "",
                "set": {
                    "name": "suspended",
                    "type": "set",
            ...
            {
                "name": "(Blamed Jefferson → out of contest)",
                "text": "",
                "set": {
                    "name": "suspended",
                    "type": "set",
            ...
            {
                "name": "(Blame backfired → Max suspended)",
                "text": "",
                "set": {
                    "name": "suspended",
                    "type": "set",
    ...
    "setup4_courtney": {
        "choices": [
            {
                "name": "(Complimented Courtney in ep2 → on VIP list)",
                "text": "",
                "set": {
                    "name": "complimented_courtney",
                    "type": "set",
                    "value": true
                },
                "next": "alt_beach_intro"
            },
            {
                "name": "(Didn't compliment Courtney → denied, gets in another way)",
                "text": "",
                "set": {
                    "name": "complimented_courtney",
                    "type": "set",
    ...
    "real_room_1": {
        "choices": [
            {
                "name": "Accepted Alternative Chloe's request",
                "text": "Chloe...you're alive. Yes!",
                "next": "real_room_kiss"
            },
            {
                "name": "Refused Alternative Chloe's request",
                "text": "Chloe...you're back.",
                "next": "real_room_kiss"
            }
        ]
    },
    "real_room_kiss": {
        "choices": [
            {
                "name": "Kissed Chloe",
                "text": "Whoa! Down, Max! You get one kiss and now you're all over me...",
                "next": "real_room_2"
            },
            {
                "name": "Didn't kiss Chloe",
                "text": "Oh yeah, now you suddenly want to kiss me? You had your chance.",
                "next": "real_room_2"
            },
            {
                "name": "Skipped that scene (Glitched Out of Bounds)",
                "text": "",
                "next": "real_room_2"
            }
        ]
    ...
    "real_room_3": {
        "choices": [
            {
                "name": "Chloe has a gun",
                "text": ["And I do have a gun now...", "Keep it in your pants."],
                "next": "real_room_4"
            },
            {
                "name": "Chloe doesn't have a gun",
                "text": ["Too bad I don't have a gun anymore...", "Yes, that's the solution."],
                "next": "real_room_4"
            }
        ]
    },
    ...
    "real_room_5": {
        "choices": [
            {
                "name": "Left the money",
                "text": ["You didn't even let me take that money to pay Frank off.", "And I'm glad. We have to be better than that."],
                "next": "real_room_6"
            },
            {
                "name": "Stole the money",
                "text": ["At least you let me take that money to pay Frank off.", "Don't remind me. I just want him off your back. Our back..."],
                "next": "real_room_6"
            }
        ]
    },
    ...
    "real_room_7": {
        "choices": [
            {
                "name": "Sided with David",
                "text": ["And be careful of step-crack...unless you want to hang out with him after you stood up for his ass yesterday.", "Oh, please."],
                "next": "real_room_8"
            },
            {
                "name": "Sided with Chloe",
                "text": ["And be careful of step-crack. He's not going to be a happy camper after you reamed him yesterday, and Mom is giving him the boot...", "I'm on it, partner."],
                "next": "real_room_8"
            }
        ]
    },
    ...
    "upstairs_bird": {
        "choices": [
            {
                "name": "Saved the bird",
                "text": ["Oh no, that poor little bird has been trapped in here!", "Fly! Be free!"],
                "next": "downstairs_david"
            },
            {
                "name": "Let the bird die",
                "text": "",
                "next": "downstairs_david"
            }
        ]
        ...
        "next": [
            {
                ...
                "type": "eq",
                "value": false,
                "node": "garage_open_david"
            },
            {
                "name": "sided_with_chloe",
                "type": "eq",
                "value": true,
                "node": "garage_open_chloe"
            }
        ]
    },
    "garage_open_david": {
        ...
        "next": [
            {
                ...
                "type": "eq",
                "value": true,
                "node": "garage_next_saved"
            },
            {
                "name": "saved_kate",
                "type": "eq",
                "value": false,
                "node": "garage_next_not"
            }
        ]
    },
    "garage_next_saved": {
        ...
        "next": [
            {
                ...
                "type": "eq",
                "value": true,
                "node": "hospital_call_ans"
            },
            {
                "name": "answered_kate_call",
                "type": "eq",
                "value": false,
                "node": "hospital_call_no"
            }
        ]
    },
    "hospital_call_ans": {
        ...
        "next": [
            {
                ...
                "type": "eq",
                "value": true,
                "node": "hospital_kate_warren2_acc"
            },
            {
                "name": "accepted_warren_invite",
                "type": "eq",
                "value": false,
                "node": "hospital_kate_warren2_dec"
            }
        ]
    },
        ...
        "next": [
            {
                ...
                "type": "eq",
                "value": true,
                "node": "hospital_kate_vic_made"
            },
            {
                "name": "made_fun_of_victoria",
                "type": "eq",
                "value": false,
                "node": "hospital_kate_vic_comf"
            }
        ]
    },
        ...
        "next": [
            {
                ...
                "type": "eq",
                "value": "nathan",
                "node": "hospital_kate_nathan_susp"
            },
            {
                "name": "suspended",
                "type": "ne",
                "value": "nathan",
                "node": "hospital_kate_nathan_not"
            }
        ]
    },
        ...
        "next": [
            {
                ...
                "type": "ne",
                "value": "jefferson",
                "node": "dorm_jeff2_didnt"
            },
            {
                "name": "suspended",
                "type": "eq",
                "value": "jefferson",
                "node": "dorm_jeff2_blamed"
            }
        ]
    },
    "dorm_jeff2_didnt": {
        "text": "I feel like a total loser, but it's been a hard week to focus. No pun intended.",
        "next": "dorm_jeff3"
    },
    "dorm_jeff2_blamed": {
        "text": "So, you don't hate me for what I said to the Principal?",
        "next": "dorm_jeff3"
    },
    "dorm_jeff3": {
        "text": [
        ...
        "next": [
            {
                ...
                "type": "eq",
                "value": false,
                "node": "beach_money_left"
            },
            {
                "name": "stole_money",
                "type": "eq",
                "value": true,
                "node": "beach_money_stole"
            }
        ]
    },
    "beach_money_left": {
        "text": "Just talk to Frank so we can get that code for the book from him. That's all.",
        "next": "beach_3"
    },
    "beach_money_stole": {
        "text": "Just pay Frank his money and then we can get that code for the book from him. That's all.",
        "next": "beach_3"
    },
    "beach_3": {
        "text": [
        ...
        "next": [
            {
                ...
                "type": "eq",
                "value": true,
                "node": "beach_money2_give"
            },
            {
                "name": "stole_money",
                "type": "eq",
                "value": false,
                "node": "beach_money2_keep"
            }
        ]
    },
    "beach_money2_give": {
    ...
    "invest_hurt": {
        "choices": [
            {
                "name": "(No one was hurt)",
                "text": ["I'm glad things worked out okay with Frank. It's nice to have one less enemy in Arcadia Bay.", "Amen to that."],
                "next": "invest_2"
            },
            {
                "name": "(Frank was injured)",
                "text": ["Sorry, I just keep thinking about shooting Frank in the leg.", "Please don't. You saved us. Frank is lucky. We have to keep moving forward."],
                "next": "invest_2"
            },
            {
                "name": "(Frank was killed)",
                "text": ["I'm sorry, I... I keep seeing Frank... dead. And I'm the one who killed him.", "Listen, you saved my life. And yours. We have to keep going forward."],
                "next": "invest_2"
            }
        ]
    },
    ...
    "parking_warren_choice": {
        "choices": [
            {
                "name": "(Max stopped Warren from beating Nathan)",
                "text": "I'm glad you stopped me... Nathan is dangerous.",
                "next": "parking_2"
            },
            {
                "name": "(Warren beat up Nathan)",
                "text": "I really flipped out on Nathan. I just hate bullies... and Max, he's dangerous.",
                "next": "parking_2"
            }
        ]
    },
        ...
        "next": [
            {
                ...
                "type": "eq",
                "value": true,
                "node": "party_courtney_listed"
            },
            {
                "name": "complimented_courtney",
                "type": "eq",
                "value": false,
                "node": "party_courtney_notlisted"
            }
        ]
    },
        ...
        "next": [
            {
                ...
                "type": "eq",
                "value": false,
                "node": "party_vic_apology_comf"
            },
            {
                "name": "made_fun_of_victoria",
                "type": "eq",
                "value": true,
                "node": "party_vic_apology_made"
            }
        ]
    },
    "party_vic_apology_comf": {
        "text": "Real cute, Max. And after I apologized to you the other day...",
        "next": "party_vic_kate"
    },
    "party_vic_apology_made": {
        "text": "Real cute, Max. You still pissed about me taking your picture?",
        "next": "party_vic_kate"
    },
    "party_vic_kate": {
        ...
        "next": [
            {
                ...
                "type": "eq",
                "value": false,
                "node": "party_vic_kate_died"
            },
            {
                "name": "saved_kate",
                "type": "eq",
                "value": true,
                "node": "party_vic_kate_lived"
            }
        ]
    },
    "party_vic_kate_died": {
        "text": "Kate Marsh killed herself in front of you and me... everybody here!",
        "next": "party_vic_blame"
    },
    "party_vic_kate_lived": {
        "text": "Kate Marsh tried to kill herself in front of you and me... everybody here!",
        "next": "party_vic_blame"
    },
    "party_vic_blame": {
    ...
    "party_vic_thoughts": {
        "choices": [
            {
                "name": "(Max didn't warn Victoria)",
                "text": "Should I have warned Victoria about Nathan? She might be evil, but...",
                "next": "party_chloe"
            },
            {
                "name": "(Victoria didn't believe Max)",
                "text": "Okay, I tried... She's not gonna believe me over her Vortex Club partner…",
                "next": "party_chloe"
            },
            {
                "name": "(Victoria believed Max)",
                "text": "Maybe there's hope yet for Victoria and me... I'm glad I warned her. I hope she's okay.",
                "next": "party_chloe"
            }
        ]
    },
        ...
        "next": [
            {
                ...
                "type": "eq",
                "value": false,
                "node": "contest_dedicate_died"
            },
            {
                "name": "saved_kate",
                "type": "eq",
                "value": true,
                "node": "contest_dedicate_lived"
            }
        ]
    },
    "contest_dedicate_died": {
        "text": "And I'd like to dedicate this prize to the memory of Kate Marsh... She was the real \"everyday hero\" of Blackwell...",
        "next": "contest_end"
    },
    "contest_dedicate_lived": {
        "text": "And I'd like to dedicate this prize to Kate Marsh... She is the real \"everyday hero\" of Blackwell. And I can't wait for her to come back.",
        "next": "contest_end"
    },
    "contest_end": {
        "text": [
