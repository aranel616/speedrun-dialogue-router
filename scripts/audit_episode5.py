"""
Audit episode5.ts against the wiki wikitext source.
Prints the full mandatory dialogue flow (scene by scene) so we can spot
missing nodes and identify choice points.

Source: the Fandom "Episode 5: Polarized - Script" page, saved as raw
...
WIKI = "/home/sarah/Episode 5_ Polarized - Script _ Life is Strange Wiki _ Fandom.wikitext"
